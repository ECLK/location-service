...
from .models import Admindistrict, Electroaldistrict, Polingdivision, Gramaniladaridivision, Locations
from .serializers import AdmindistrictSerializer, ElectroaldistrictSerializer, PolingdivisionSerializer, GramaniladaridivisionSerializer, LocationsSerializer
